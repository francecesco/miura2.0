...
public class C0115d extends AutoCompleteTextView implements androidx.core.widget.l {

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int[] f1832d = {R.attr.popupBackground};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final C0116e f1833a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final E f1834b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final C0124m f1835c;

    public C0115d(Context context, AttributeSet attributeSet) {
    ...
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1834b.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1835c.d(AbstractC0126o.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f1835c.a(keyListener));
    }
    ...
    public C0115d(Context context, AttributeSet attributeSet, int i2) {
        super(b0.b(context), attributeSet, i2);
        a0.a(this, getContext());
        e0 e0VarU = e0.u(getContext(), attributeSet, f1832d, i2, 0);
        if (e0VarU.r(0)) {
