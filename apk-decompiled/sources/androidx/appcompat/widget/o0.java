...
public class o0 extends X {
    ...
    private final WeakReference f1936b;

    public o0(Context context, Resources resources) {
        super(resources);
        this.f1936b = new WeakReference(context);
    }
    ...
    public Drawable getDrawable(int i2) {
        Context context = (Context) this.f1936b.get();
        return context != null ? W.h().t(context, this, i2) : a(i2);
    }
