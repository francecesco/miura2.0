...
public abstract class d {
    ...
    private static class a implements TypeEvaluator {
        ...
        public h.b[] evaluate(float f2, h.b[] bVarArr, h.b[] bVarArr2) {
            ...
            if (!h.b(this.f3246a, bVarArr)) {
                this.f3246a = h.f(bVarArr);
            }
            for (int i2 = 0; i2 < bVarArr.length; i2++) {
                this.f3246a[i2].h(bVarArr[i2], bVarArr2[i2], f2);
            }
            return this.f3246a;
        }
    }
    ...
    */
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArrayK = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f3230j);
        int i2 = 0;
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayK = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f3227g);
        TypedArray typedArrayK2 = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f3231k);
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray typedArrayK = k.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f3229i);
