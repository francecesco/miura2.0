...
public abstract class j {
    ...
    public static String a(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < iArrC.length; i2++) {
            ...
            stringBuffer.append(Integer.toHexString(iArrC[i2]));
        }
    ...
    public static final boolean f(Date date) {
        return e(date, new Date(System.currentTimeMillis()));
    }

    public static final boolean g(Date date) {
        return e(date, new Date(System.currentTimeMillis() - 86400000));
    }
